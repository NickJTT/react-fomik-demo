...
export default function ResetFormData() {
    const [formValues, setFormValues] = useState(null);

    const initialValues = { name: '', email: '', channel: '', comments: '', address: '', social: { facebook: '', twitter: '' }, phoneNumbers: ['', ''], phNumbers: [''] };

    const savedValues = { name: 'Test', email: 'test@gmail.com', channel: 'Test Channel', comments: 'Test Comments', address: 'Test Address', social: { facebook: '', twitter: '' }, phoneNumbers: ['', ''], phNumbers: [''] };
        ...
        <Formik initialValues = { formValues || initialValues } validationSchema = { validationSchema } onSubmit = { onSubmit } validateOnMount enableReinitialize>
            {
                ...
                <button type = 'button' onClick = { () => setFormValues(savedValues) }>Load</button>
